...
const GeneralConfigComponent: React.FC = () => {
  const { timeRanges, setTimeRanges, topCommentsLimit, setTopCommentsLimit, topPostsLimit, setTopPostsLimit, lastHours, setLastHours } =
    useConfig();
    ...
    <div className='container mx-auto p-4 max-w-4xl'>
      ...
      <div>
        <div className='border-b border-gray-700 mb-4'>
          <label className='block text-sm font-medium text-gray-300 mb-1'>New posts from the last (hours)</label>
          <input
            type='number'
            min={1}
            max={12}
